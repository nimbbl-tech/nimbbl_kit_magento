...
{    
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $element->setComment("*Please use below url for webhook* <span style='width:300px;font-weight: bold;' class='rzp-webhook-url' >" . $baseUrl . "nimbbl/payment/webhook</span>" . $copyButton );
